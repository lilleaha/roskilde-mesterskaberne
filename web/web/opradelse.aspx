...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <%--Gentag din kodeord/passwood til at få det rigtig kodeord/passwood til databasen--%>
                     ...
                     <asp:TextBox ID="TextBoxRepeatPassword" runat="server" TextMode="Password"></asp:TextBox><asp:Label ID="LabelFail" runat="server" ForeColor="#ff0000" Visible="false">The passwords do not match.</asp:Label>
